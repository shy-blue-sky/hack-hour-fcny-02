...
const bstReverse = (root: BinarySearchTree | null): BinarySearchTree | null => {
  return null;
};
...
const sortedArrayToBST = (arr: number[]): BinarySearchTree | null => {
  return null;
};

export { BinarySearchTree, bstReverse, sortedArrayToBST };
